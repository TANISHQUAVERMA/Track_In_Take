...
def seed_foods_for_diet(diet_type, meal_type=None, stdout=None):
    ...
    prompt = f"""
Generate 30 unique healthy Indian food items suitable for {diet_type} diet, {meal_filter}.
...
- All numeric fields must be realistic Indian food values
- Generate diverse, popular Indian dishes
"""
